...
// Initialize the formDatas array with empty objects
...
function loadFormData() {
    ...
    if (savedFormDatas) {
      ...
      formDatas.splice(0, formDatas.length, ...savedFormDatas);
    }
  }
...
function saveFormData() {
    ...
    const visibleFormData = formDatas[visibleIndex];
    ...
    // Save the formDatas array to local storage
